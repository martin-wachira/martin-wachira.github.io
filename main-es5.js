...
var RegisterService = /** @class */ (function () {
    function RegisterService(http, fs, db) {
        this.http = http;
        this.fs = fs;
        this.db = db;
        this.movieCollection = this.fs.collection('movies', function (ref) { return ref.orderBy('title', 'asc'); });
        this.movies = this.movieCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (changes) {
    ...
    RegisterService.prototype.getAllMovies = function () {
        return this.movies;
    };
    RegisterService.prototype.getMovie = function (id) {
        return this.getAllMovies()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (movies) { return movies.find(function (m) { return m.id === id; }); }));
    };
    RegisterService.prototype.handleError = function (err) {
        var errorMessage = '';
    ...
    RegisterService.prototype.submitRegister = function (body) {
    ...
    RegisterService.prototype.getUserName = function () {
...
var WelcomeComponent = /** @class */ (function () {
    function WelcomeComponent(fb, service, router, a_route, db) {
        this.fb = fb;
    ...
    WelcomeComponent.prototype.ngOnInit = function () {
        ...
        this.service.getAllMovies().subscribe(function (movies) {
            _this.movies = movies;
        });
    };
    WelcomeComponent.prototype.gotoDetails = function (id) {
        this.router.navigate(['/movie', id]);
    };
    WelcomeComponent.prototype.setMessage = function (c) {
        var _this = this;
        this.passMessage = '';
        if ((c.touched || c.dirty) && c.errors) {
            this.passMessage = Object.keys(c.errors).map(function (key) { return _this.validationMessages[key]; }).join(' ');
        }
    };
    WelcomeComponent.prototype.toggleLike = function () {
    ...
    WelcomeComponent.prototype.register = function () {
        ...
        if (this.validatingForm.valid) {
            this.service.submitRegister(this.validatingForm.value)
                .subscribe(function (data) { return _this.successMessage = 'Registration Successfuly'; }, function (error) { return _this.successMessage = 'Some errors'; });
        }
    };
    WelcomeComponent.prototype.moveToLogin = function () {
        this.router.navigate(['../login'], { relativeTo: this.a_route });
    };
    WelcomeComponent.prototype.gotoFav = function () {
        this.router.navigate(['../favorite'], { relativeTo: this.a_route });
    };
    Object.defineProperty(WelcomeComponent.prototype, "username", {
        get: function () {
    ...
    Object.defineProperty(WelcomeComponent.prototype, "email", {
        get: function () {
    ...
    Object.defineProperty(WelcomeComponent.prototype, "password", {
        get: function () {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, service, router, a_route) {
        this.fb = fb;
        this.service = service;
        this.router = router;
        this.a_route = a_route;
    ...
    LoginComponent.prototype.login = function () {
        ...
        if (this.loginForm.valid) {
            this.service.login(this.loginForm.value)
                ...
                _this.router.navigate(['/favorite']);
            }, function (error) { });
        }
    };
...
var MovieComponent = /** @class */ (function () {
    function MovieComponent(service, a_route) {
        this.service = service;
        this.a_route = a_route;
    }
    MovieComponent.prototype.ngOnInit = function () {
        var param = this.a_route.snapshot.paramMap.get('id');
        if (param) {
            var id = param;
            this.getMovie(id);
        }
    ...
    MovieComponent.prototype.getMovie = function (id) {
        ...
        this.service.getMovie(id).subscribe({
            next: function (movie) { return _this.movie = movie; },
        });
    };
